...
// Events Schema, Attendees Array binded too
const EventSchema = new mongoose.Schema({
    ...
    registration: [AttendeesSchema],  // Embed AttendeesSchema for attendee information
});

export const EventModel = mongoose.model('event', EventSchema);

// Interact with the events collection
